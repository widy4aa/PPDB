  ...
  <div class="content-wrapper" style="background-color: #7FB77E;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-white">Edit Jurusan <?= $_GET['jurusan'] ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Edit Input Jurusan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="action/proses_edit_jurusan.php?jurusan=<?= $_GET['jurusan'] ?>" method="POST">
                <div class="card-body">
