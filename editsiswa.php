                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="nik" value="<?= $siswa['nik'] ?>" class="form-control" id="NIK" placeholder="Masukkan NIK" required>
                    </div>
                    </div>
                    <div class="col-sm-5">
                  <div class="form-group">
                      <label for="NOMORKK">NOMOR KK</label>
                      <input type="number" name="kk" value="<?= $siswa['kk'] ?>" class="form-control" id="NOMORKK" placeholder="Masukkan Nomor KK" required>
                    </div>
                    </div>
                  </div>
                  <div class="form-group">
                      <label for="NISN">NISN</label>
                      <input type="number" name="nisn" value="<?= $siswa['nisn'] ?>" class="form-control" id="NISN" placeholder="Masukkan NISN" required>
                  </div>
              <div class="form-group">
                  <label for="NAMASISWA">NAMA SISWA</label>
                  <input type="text" name="nama" value="<?= $siswa['nama'] ?>" class="form-control" id="NAMASISWA" placeholder="Masukkan Nama Siswa" required>
              </div>
              <div class="form-group">
              <label for="NAMASISWA">TGL LAHIR</label>
              <div class="input-group date" id="datepicker">
            <input type="date" name="tgl_lahir" class="form-control" value="<?= $siswa['tgl_lahir'] ?>" id="date" required />
            </div>
              </div>
              <div class="form-group">
                  <label>JURUSAN</label>
                  <select class="form-control select2" name="jurusan" style="width: 100%;" required>
                  <?php 
              ...
              <div class="input-group date" id="datepicker">
            <input type="date" name="tgl_pendaftaran" value="<?= $siswa['tgl_pendaftaran'] ?>" class="form-control" id="date" required />
            </div>
              </div>
              <div class="form-group">
                      <label for="NOMORKK">NOMOR HP</label>
                      <input type="number" name="no_hp" value="<?= $siswa['no_hp'] ?>" class="form-control" id="NOMORKK" placeholder="Masukkan Nomor HP" required>
              </div>
              <div class="row">
                    <div class="col-sm-5">
                    <div class="form-group">
                      <label for="NIK">NAMA AYAH</label>
                      <input type="text" name="nama_ayah" value="<?= $siswa['nama_ayah'] ?>" class="form-control" id="NIK" placeholder="Masukkan Nama Ayah" required>
                    </div>
                    </div>
                    <div class="col-sm-5">
                  <div class="form-group">
                      <label for="NOMORKK">NAMA IBU</label>
                      <input type="text" name="nama_ibu" value="<?= $siswa['nama_ibu'] ?>" class="form-control" id="NOMORKK" placeholder="Masukkan Nama Ibu" required>
                  </div>
                    </div>
                </div>
                <div class="form-group">
                      <label for="NOMORKK">ASAL SEKOLAH</label>
                      <input type="text" name="asal_sekolah" value="<?= $siswa['asal_sekolah'] ?>" class="form-control" id="NOMORKK" placeholder="Masukkan Asal Sekolah" required>
              </div>
                <div class="form-group">
                      <label for="NIK">ALAMAT</label>
                      <textarea name="alamat" id="" cols="30" rows="10" class="form-control" required><?= $siswa['alamat'] ?></textarea>
                  </div>
                  <div>
