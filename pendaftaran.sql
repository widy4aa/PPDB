...
--
-- Host: localhost:3306
-- Generation Time: Sep 10, 2022 at 02:38 AM
...
(4, '2132132132', '2312321321', '16623312', 'bambang yoga', '2022-09-07', 'RPL', '2022-09-14', 853203712, 'jember', 'sugen', 'bambang', 'smp it', 0),
...
--
ALTER TABLE `calon_siswa`
  ADD CONSTRAINT `calon_siswa_ibfk_1` FOREIGN KEY (`jurusan`) REFERENCES `jurusan` (`jurusan`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
